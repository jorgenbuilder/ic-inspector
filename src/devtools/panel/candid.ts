...
import { Bool, Empty, Float32, Float64, Func, Int, Int16, Int32, Int64, Int8, Nat, Nat16, Nat32, Nat64, Nat8, Null, Opt, Principal, Rec, RecClass, Record, Reserved, Service, Text, Tuple, Type, Variant, Vec } from '@dfinity/candid/lib/cjs/idl';
